...
QDataStream &operator<<(QDataStream &out, QuickInspectorInterface::PreviewMode value)
{
    out << qint32(value);
    return out;
}

QDataStream &operator>>(QDataStream &in, QuickInspectorInterface::PreviewMode &value)
{
    qint32 t;
    in >> t;
    value = static_cast<QuickInspectorInterface::PreviewMode>(t);
    return in;
}
    ...
    : QObject(parent)
{
    ...
    qRegisterMetaTypeStreamOperators<PreviewMode>();
}
